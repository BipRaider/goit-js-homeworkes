...
const lightbox__button = lightbox.querySelector('button[data-action="close-lightbox"]');
...
//Прослушка
gallery.addEventListener('click', (event) => openFullImg(event, lightbox, lightbox__image));
lightbox.addEventListener('click', (event) => closeIMG(event, lightbox, lightbox__image, users, gallery));
lightbox.addEventListener('click', (event) => clickImg(event, users, gallery));
document.addEventListener('keydown', (event) => keyDown(event, lightbox__image, users, data));
...
function clickImg(event, user, gall) {
	...
	// let chil = gall.children;
	// let chil2 = gall.firstElementChild.nextElementSibling;

	// // if (chil2.firstElementChild.href !== target.currentSrc) {
	// // 	target.src = gall.firstElementChild.nextElementSibling.firstElementChild.href;
	// // }
	// // if (chil.firstElementChild === target.currentSrc) {
	// // 	target.currentSrc = 0;
	// // }

	// console.log('chil2 входящая картинка ', chil2.firstElementChild.href);
	// console.log('chil2. следующая картинка  входящая картинка ', chil2.nextElementSibling.firstElementChild.href);
	// console.log(chil2.firstElementChild);
	// console.log(
	// 	'картинка первого елемента галерей',
	// 	'gall первый/следующий/первый/картинка',
	// 	gall.firstElementChild.nextElementSibling.firstElementChild.href
	// );
	// console.log('логи значения приходят');
	// console.log('target.currentSrc ', target.currentSrc);
	// console.log('target', target);
	// console.log('tergetfocues', currentTarget);
	// console.log('какие значения приходят');
	// console.dir(gall);
